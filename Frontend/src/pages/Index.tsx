      ...
      <nav className="border-b border-border bg-card/60 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="font-display text-xs uppercase tracking-wider text-muted-foreground hover:text-primary transition-colors">Dashboard</a>
            <a href="#" className="font-display text-xs uppercase tracking-wider text-primary">Players</a>
            <a href="#" className="font-display text-xs uppercase tracking-wider text-muted-foreground hover:text-primary transition-colors">Compare</a>
            <a href="#" className="font-display text-xs uppercase tracking-wider text-muted-foreground hover:text-primary transition-colors">Draft Board</a>
          </div>
        </div>
      </nav>
